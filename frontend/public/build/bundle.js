...
var app = (function (svelteRoutine) {
    'use strict';
    ...
    function get_each_context(ctx, list, i) {
    	...
    	child_ctx[3] = list[i].to;
    	return child_ctx;
    }

    // (18:4) <Link to="{ to }" getProps="{ getProps }">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(18:4) <Link to=\\\"{ to }\\\" getProps=\\\"{ getProps }\\\">",
    		ctx
    	});
    ...
    // (17:2) {#each links as { label, to }}
    function create_each_block(ctx) {
    	let link;
    	let current;

    	link = new svelteRoutine.Link({
    			props: {
    				to: /*to*/ ctx[3],
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(17:2) {#each links as { label, to }}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			...
    			add_location(nav, file, 15, 0, 398);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Link: svelteRoutine.Link, links, getProps });
    ...
    const file$2 = "src/routes/Bugs.svelte";
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(p, file$2, 24, 2, 495);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	let pre;
    	let t_value = JSON.stringify(/*data*/ ctx[0], null, 2) + "";
    	let t;
    	...
    	const block = {
    		...
    		h: function hydrate() {
    			add_location(pre, file$2, 22, 2, 440);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*data*/ 1 && t_value !== (t_value = JSON.stringify(/*data*/ ctx[0], null, 2) + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment$5(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*data*/ ctx[0]) return create_if_block$1;
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const testData = {
    		"ids": ["5f65110a91ba911fe0b3cc4a", "5f65052e964a307f201ca372"]
    	};

    	onMount(() => post(endpoint, testData, res => $$invalidate(0, data = res)));
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Bugs> was created with unknown prop '${key}'`);
    	});
    ...
    function create_default_slot$4(ctx) {
    	...
    	route1 = new Route({
    			props: { path: "/bugs", component: Bugs },
    			$$inline: true
    		});

    	route2 = new Route({
    			props: { path: "/fish", component: Fish },
    			$$inline: true
    		});
